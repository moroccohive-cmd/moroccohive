        ...
        <div className="p-8 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Create a new story for your audience</p>
                </div>
            </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6 space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="e.g., 10 Must-Visit Places in Marrakech"
                            required
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="e.g., must-visit-marrakech"
                            required
